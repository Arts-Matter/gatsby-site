  ...
  return (
    <div className="resources-filter-group">
      ...
      { width > 889
        ...
        : <button className="resources-filter-group__button" aria-expanded={groupExpanded} aria-controls={ 'filter-group-' + groupID } onClick={handleGroupExpanderClick}>
            {group.groupName}
            <span className="resources-filter-group__button-indicator" aria-hidden="true"></span>
          </button>
      }
      </h3>
      <div className={"resources-filter-group__drawer " + ( groupExpanded ? 'resources-filter-group__drawer--is-open' : '' )} id={ 'filter-group-' + groupID }>
