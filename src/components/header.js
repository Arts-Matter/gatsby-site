    ...
    <header ref={headerRef} className="header header--primary">
      ...
      <div className="header-container">
        <h1 className="header-container__title">
          <Link to="/" className="header-container__navLink" aria-label="Homepage">
            <div
        ...
        />
        <nav className="nav" ref={mobileNavRef} aria-labelledby="main-menu" hidden={( width > 889 || mobileExpanded ) ? false : true}>
