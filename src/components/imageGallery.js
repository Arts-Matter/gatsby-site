          ...
          <div className="gallery-image-wrapper">
            ...
            >
              {(image.caption || image.title) && (
                <div className={index === curIndex ? 'gallery-image__caption gallery-image__caption--active' : 'gallery-image__caption'}>
                  {image.title && (<div className="gallery-image__caption-title">{image.title}</div>)}
                  {image.caption && (<p className="gallery-image__caption-text">{image.caption}</p>)}
                </div>
              )}
            </div>
            )
